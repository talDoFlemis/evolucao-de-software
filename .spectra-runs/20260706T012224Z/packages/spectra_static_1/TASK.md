...
Task: translate the embedded cat.c into a standalone idiomatic Go command-line program using exactly one validated static specification.
...
SPECTRA rule: use the attached static spec to guide translation. Do not combine other spec modalities.
