...
Task: translate the embedded cat.c into a standalone idiomatic Go command-line program using exactly one validated descriptions specification.
...
SPECTRA rule: use the attached descriptions spec to guide translation. Do not combine other spec modalities.
